    ...
    <div className="h-full overflow-y-auto bg-base-200">
      ...
      <div className="p-4 sm:p-6 bg-base-100 border-b border-base-300">
        <div className="flex items-start justify-between gap-3 mb-2 sm:mb-3">
          <h1 className="text-xl sm:text-3xl font-bold text-base-content leading-tight">{problem.title}</h1>
          <span className={`badge ${getDifficultyBadgeClass(problem.difficulty)} shrink-0`}>
            {problem.difficulty}
          </span>
        </div>
        <p className="text-sm sm:text-base text-base-content/60">{problem.category}</p>
      ...
      <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="bg-base-100 rounded-xl shadow-sm p-4 sm:p-5 border border-base-300">
          <h2 className="text-lg sm:text-xl font-bold text-base-content mb-2 sm:mb-3">Description</h2>
